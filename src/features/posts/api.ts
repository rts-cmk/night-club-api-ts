...
import { postSchema, type NewPost, commentSchema, type NewComment } from "./validation";
import { getAllPosts, getPostById, createPost, addCommentToPost, updatePost, deletePost } from "./services";
